...
# Load the logo image
logo_path = "C:\\Users\\Lenovo\\AIRFLOW_DOCKER_1\\streamlit\\resources\\logos.png"
...
if page_selection == "Home":
    ...
    **Oracle Product Names**
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Top 10 Best-Selling Products' plot shows the products with the highest sales volume. <br><br> This visualization highlights the top-performing products in terms of quantity sold, providing insights into customer preferences and popular items.</p>",
            unsafe_allow_html=True
        )
    # Monthly Sales Trend
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Monthly Sales Trend' plot displays the total sales revenue for each month. <br><br> It helps in understanding the sales performance over time, identifying peak sales periods, and evaluating seasonal trends or patterns.</p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Revenue Contribution by Product Category' plot shows the percentage of total revenue generated by each product category. <br><br> It highlights the most financially significant categories and helps identify which ones drive the most revenu</p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Monetary Distribution' plot is a histogram that displays the distribution of total spending per order, showing the frequency of different spending levels by customers. <br><br> It helps to understand the monetary value of transactions, indicating how much customers typically spend in a single purchase. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Distribution of Discount Percentages' plot is a histogram that displays the frequency distribution of discount percentages applied to products. <br><br> It provides insight into the range and prevalence of discounts offered on products. <br><br> This plot helps to identify common discount levels and the extent of price reductions across the product range. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Discount Percentage by Category' plot shows the variation in discount percentages across different product categories. <br><br> This visualization helps to understand how discounting strategies differ between categories and which categories offer higher or lower discounts. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Scatter Plot of Discount Percentage vs. Ordered Quantity' shows the relationship between the discount percentage applied to products and the quantity ordered. <br><br> It helps to analyze whether higher discounts correlate with higher sales volumes, providing insights into the effectiveness of discount strategies </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Comparison of Average Discounts for Popular and Less Popular Items' plot is a histogram that compares the average discount percentages applied to popular and less popular items. <br><br> The items are categorized based on their sales volume, with 'popular' items having sales above the median and 'less popular' items below. <br><br> This plot helps to understand how discount strategies vary based on product popularity, showing the distribution of average discounts for each category. It provides insight into whether popular or less popular items receive larger discounts on average. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Box Plot of Unit Selling Prices by Top Performing Product Categories' visualizes the range and distribution of unit selling prices across the top-performing product categories. <br><br> This plot provides insight into the pricing strategies within these categories, highlighting price variations and the median price point. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Top Distributing Companies by Quantity Shipped' treemap visualizes the quantity of items shipped by each distributor. It provides a clear view of the most active distribution companies, showing their relative contribution to the total shipments. <br><br> This visualization helps to understand the role and impact of different distributors in the supply chain. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Transaction Diversity' plot shows the diversity in transactions by displaying the number of unique items purchased in each transaction. <br><br> It helps to understand whether customers are buying a wide variety of products or focusing on a few specific items. </p>",
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            "<p style='font-size:30px'> <br><br> The 'Distribution of Item Frequencies' plot shows how frequently each product is purchased. <br><br> This plot provides insight into product popularity and helps identify which products are commonly bought together. </p>",
            unsafe_allow_html=True
        )
